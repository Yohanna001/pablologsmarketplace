    ...
    <div className="flex flex-col min-h-screen bg-[#FAFAFC]">
      ...
      >
        ...
        <a
          ...
          className="w-11 h-11 rounded-full bg-[#25D366] hover:bg-[#128C7E] text-white flex items-center justify-center shadow-[0_4px_12px_rgba(0,0,0,0.3)] transition transform hover:scale-105 active:scale-95 cursor-pointer border border-white/10"
        ...
        >
          <svg className="w-5.5 h-5.5 fill-white" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            <path d="M.057 24l1.687-6.163c-1.041-1.804-1.588-3.849-1.587-5.946C.06 5.348 5.397.01 12.008.01c3.202.001 6.212 1.246 8.477 3.514 2.266 2.268 3.507 5.28 3.505 8.484-.004 6.657-5.34 11.997-11.953 11.997-2.005-.001-3.973-.502-5.717-1.454L0 24zm6.59-4.846c1.6.95 3.197 1.451 4.839 1.453 5.46.002 9.897-4.437 9.9-9.899.001-2.646-1.02-5.133-2.875-6.99C16.606 1.861 14.12 .836 11.48.835 6.02.835 1.583 5.273 1.582 10.733c-.001 1.745.454 3.447 1.321 4.957l-1.022 3.73 3.829-1.004c1.472.804 3.111 1.228 4.777 1.228h.001z" />
